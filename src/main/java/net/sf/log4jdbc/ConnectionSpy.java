...
public class ConnectionSpy implements Connection, Spy {
     ...
     * objects.
     */
    private static final Map CONNECTION_TRACKER = new HashMap();
    ...
    public static String getOpenConnectionsDump() {
        ...
        int size;
        Integer[] keysArr;
        synchronized (CONNECTION_TRACKER) {
            size = CONNECTION_TRACKER.size();
            if (size == 0) {
                return "open connections:  none";
            }
            Set keys = CONNECTION_TRACKER.keySet();
     ...
     *
     * @param realConnection &quot;real&quot; Connection that this ConnectionSpy
     * wraps.
     */
     ...
     * @param realConnection &quot;real&quot; Connection that this ConnectionSpy
     * wraps.
     * @param rdbmsSpecifics the RdbmsSpecifics object for formatting logging
     * appropriate for the Rdbms used.
     */
    public ConnectionSpy(Connection realConnection, RdbmsSpecifics rdbmsSpecifics) {
        ...
        synchronized (CONNECTION_TRACKER) {
            ...
            CONNECTION_TRACKER.put(connectionNumber, this);
        }
    ...
    public void close() throws SQLException {
        ...
        try {
            ...
            synchronized (CONNECTION_TRACKER) {
                CONNECTION_TRACKER.remove(connectionNumber);
            }
