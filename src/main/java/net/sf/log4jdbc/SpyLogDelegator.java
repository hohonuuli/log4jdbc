...
/**
 * Delegates Spy events to a logger. This interface is used for all logging
 * activity used by log4jdbc and hides the specific implementation of any given
 * logging system from log4jdbc.
 *
 * @author Arthur Blake
 */
public interface SpyLogDelegator {
     ...
     * @param execTime optional amount of time that passed before an exception
     * was thrown when sql was being executed. caller should pass -1 if not used
     */
     ...
     * @param returnMsg return value converted to a String for integral types,
     * or String representation for Object return types this will be null for
     * void return types.
     */
    ...
    /**
     * Similar to sqlOccured, but reported after SQL executes and used to report
     * timing stats on the SQL
     *
     * @param spy the Spy wrapping the class where the SQL occured.
