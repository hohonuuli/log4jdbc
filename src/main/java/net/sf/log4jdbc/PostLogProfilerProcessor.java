...
/**
 * Post processes an existing sqltiming log, and creates a profiling report from
 * it. Name of log file is passed in on the command line as the only argument.
 *
 * Assumptions:
 *
 * 1. Each sql statement in the log is separated by a blank line. 2. Each sql
 * statement is terminated with the timing string "{executed in N msec}" where N
 * is the number of milliseconds that the sql executed in.
 *
 */
public class PostLogProfilerProcessor {
     ...
     *
     * @param args command line arguments. Expects one argument, the name of the
    ...
    /**
     * Process given filename, and produce sql profiling report to given
     * PrintStream.
     *
    ...
    private class ProfiledSql implements Comparable {
         ...
         *
         * In this case the comparison is used to sort flagged sql in descending
         * order.
         *
         * @param o ProfiledSql Object to compare to this ProfiledSql. Must not
         * be null.
         */
        @Override
