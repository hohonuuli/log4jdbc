...
public class ResultSetSpy implements ResultSet, Spy {
    ...
    /**
     * Create a new ResultSetSpy that wraps another ResultSet object, that logs
     * all method calls, expceptions, etc.
     *
    ...
    public <T> T getObject(String columnLabel, Class<T> type) throws SQLException {
        String methodCall = "getNetworkTimeout(" + columnLabel + ", " + type + ")";
        try {
