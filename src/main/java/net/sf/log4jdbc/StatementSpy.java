...
public class StatementSpy implements Statement, Spy {
     ...
     * @param realStatement real underlying Statement that this StatementSpy
     * wraps.
     */
    ...
    /**
     * Report an exception to be logged which includes timing data on a sql
     * failure.
     *
     * @param methodCall description of method call and arguments passed to it
     * that generated the exception.
     * @param exception exception that was generated
     * @param sql SQL associated with the call.
     * @param execTime amount of time that the jdbc driver was chugging on the
     * SQL before it threw an exception.
     */
    ...
    /**
     * Report (for logging) that a method returned. All the other reportReturn
     * methods are conveniance methods that call this method.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
     * @param msg description of what the return value that was returned. may be
     * an empty String for void return types.
     */
    ...
    /**
     * Conveniance method to report (for logging) that a method returned a
     * boolean value.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned a byte
     * value.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned a int
     * value.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned a short
     * value.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned a long
     * value.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned a float
     * value.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned an
     * Object.
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Conveniance method to report (for logging) that a method returned (void
     * return type).
     *
     * @param methodCall description of method call and arguments passed to it
     * that returned.
    ...
    /**
     * Running one-off statement sql is generally inefficient and a bad idea for
     * various reasons, so give a warning when this is done.
     */
    private static final String StatementSqlWarning = "{WARNING: Statement used to run SQL} ";

    /**
     * Report SQL for logging with a warning that it was generated from a
     * statement.
     *
